            ...
            >
              <div className="flex flex-col gap-3 items-center text-center">
                ...
                <p className="dark:text-dark_black">
                  Диагностика, замена комплектующих, чистка, настройка. Вернем
...
>>>>>>> 5bd4f5e (upd)
                ...
                <svg
                  ...
                  className="group-hover:-translate-x-26 transition-all duration-200 ease-in-out group-hover:rotate-45"
                >
                  <rect
                    width="32"
                    height="32"
