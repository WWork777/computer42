          ...
          <div className='flex flex-col gap-12'>
            ...
            <motion.div
              ...
              <h4 className='text-white text-center xl:text-left'>
                Убедитесь в качестве нашего ремонта!
                <br /> Подпишитесь на наши социальные сети!
              </h4>
              <div className='flex flex-col sm:flex-row gap-3 items-center'>
                <Link
                  href='https://t.me/computer42kem'
                  ...
                  <svg
                    ...
                    className='group-hover:-translate-x-23 transition-all duration-200 ease-in-out'>
                    <rect
                      width='32'
                      height='32'
                      rx='16'
                ...
                <Link
                  href='https://vk.com/computer42kem'
                  ...
                  <svg
                    ...
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                    className='group-hover:-translate-x-[100px] transition-all duration-200 ease-in-out '>
