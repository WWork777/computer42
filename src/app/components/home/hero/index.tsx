          ...
          <div ref={ref} className="flex flex-col gap-8">
            ...
            >
              ...
              <p className="max-w-38 text-dark_black/60 dark:text-white/60">
                В Компьютер42 мы помогаем юридическим и физическим лицам
                Кемерово быстро и качественно восстанавливать работоспособность
                компьютеров. Предлагаем индивидуальные решения для ремонта и
